...
function gotoFullSearch() {
    var attackVersion = encodeURIComponent(Alpine.store('global').versionPicker.cur_version);
...
function gotoSuggestions() {
    ...
    let version = encodeURIComponent(Alpine.store('global').versionPicker.cur_version);
...
function changeVersionStageTwo(new_version) {
    ...
    // (edit tree) ->
        ...
        populateSidebar();
        jumpToIDChangeVersion(encodeURIComponent(Alpine.store('global').versionPicker.cur_version));
    }
